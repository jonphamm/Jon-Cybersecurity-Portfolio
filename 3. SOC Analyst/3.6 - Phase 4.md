...
1. First, we ensure we have correct privileges to perform privileged actions on the Windows
...
2. Now, switch over to **LimaCharlie** to locate the relevent telemetry.
