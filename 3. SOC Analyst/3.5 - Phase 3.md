...
5. We will now use **Python** to download the C2 payload from the **Ubuntu VM** to our **Windows 10 VM**:
   ...
   - Next, the following **Python** command will spin up a **temporary server**:
